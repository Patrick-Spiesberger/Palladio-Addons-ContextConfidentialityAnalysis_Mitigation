...
import KAMP4attackModificationmarks.CompromisedAssembly;
import KAMP4attackModificationmarks.CompromisedData;
import KAMP4attackModificationmarks.CompromisedLinkingResource;
import KAMP4attackModificationmarks.CompromisedResource;
import KAMP4attackModificationmarks.CompromisedService;
import KAMP4attackModificationmarks.ContextChange;
 ...
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#getContextchange <em>Contextchange</em>}</li>
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#isChanged <em>Changed</em>}</li>
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#getCompromisedlinkingresource <em>Compromisedlinkingresource</em>}</li>
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#getCompromisedservice <em>Compromisedservice</em>}</li>
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#getServicerestrictioncontainer <em>Servicerestrictioncontainer</em>}</li>
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#getCompromiseddata <em>Compromiseddata</em>}</li>
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#getDatamodelcontainer <em>Datamodelcontainer</em>}</li>
 *   <li>{@link KAMP4attackModificationmarks.impl.CredentialChangeImpl#getCompromisedassembly <em>Compromisedassembly</em>}</li>
 * </ul>
 *
 * @generated
 */
